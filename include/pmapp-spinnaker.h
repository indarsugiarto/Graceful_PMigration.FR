...
#define ITCM_SIZE		0x00006000	// Indar: this is modified for pmagent (0x6000 = 24KB = 0x8000(32KB)-0x2000(pmagent))
...
#define DTCM_SIZE		0x0000EC00	// Indar: this is the remaining 59KB (after pmagent with 2KB of data and 2KB pmagent's stack)
